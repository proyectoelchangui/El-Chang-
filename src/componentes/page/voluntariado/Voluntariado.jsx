        ...
        <>
            <div className="container">
                    ...
                    <div className="divFlexValoresVoluntariado">
                        ...
                        <div className="divFlexFotoDerValoresVoluntariado">
                            <div className="divColorFotoDerValoresVoluntariado">
                                <img className="FotoDerValoresVoluntariado" src={'https://firebasestorage.googleapis.com/v0/b/el-changui.appspot.com/o/Voluntariado%2FSonriendo.jpg?alt=media&token=24391595-5dc4-40a6-9422-f033341b4e7f'} alt="" />
                            </div>
                        </div>
                    </div>
                ...
                <div className="containerPropuestaVoluntariado">
                    <div className="divFlexPropuestaVoluntariado">
                        ...
                        <div className="divFotoDerPropuestaVoluntariado">
                            <img className="fotoDerPropuestaVoluntariado" src={'https://firebasestorage.googleapis.com/v0/b/el-changui.appspot.com/o/Voluntariado%2FSonriendo.jpg?alt=media&token=24391595-5dc4-40a6-9422-f033341b4e7f'} alt="" />
                        </div>
                    </div>
                </div>
                ...
                <div className="holaquetal">
                    <img className="holaquetalfoto" src={'https://firebasestorage.googleapis.com/v0/b/el-changui.appspot.com/o/Voluntariado%2FSonriendo.jpg?alt=media&token=24391595-5dc4-40a6-9422-f033341b4e7f'} alt="" />
                </div>
